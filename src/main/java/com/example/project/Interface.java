...
public class Interface {
    ...
    // Static variables to track indexes (though they're unused in the current code).
    ...
    public void run() {
        // Loop continues until the user chooses to exit (number == 0).
        while (number != 0) {
            ...
            // Option 1: Add a new book to the bookstore.
                ...
                String isbn = scan.nextLine(); // Consume leftover newline from nextInt.
            ...
            // Option 4: Display all books in the bookstore.
                ...
                Book[] book = bookStore.getBooks();
                for (Book bk : book) {
                    if (bk != null) {  // Check for null values before printing.
                        System.out.println(bk.bookInfo());
                    }
                }
            }
            // Option 5: Register a new student.
            else if (number == 5) {
